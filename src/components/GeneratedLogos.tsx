      ...
      <div className="relative py-32 overflow-hidden">
        ...
        <div className="relative text-center mb-20">
          ...
          >
            ...
            <h2 className="text-5xl font-bold text-white text-transparent bg-clip-text">
              Creative Showcase
            </h2>
            <Star className="absolute -bottom-6 -right-6 w-8 h-8 text-yellow-400 animate-pulse delay-300" />
          </motion.div>
          <p className="text-xl text-white italic mt-4 max-w-2xl mx-auto">
            Witness the magic of AI-powered design through our latest
            masterpieces
          </p>
        </div>

        {/* Scrolling Box */}
        <div className="relative mx-auto w-full max-w-5xl h-[500px] overflow-hidden rounded-lg shadow-lg border border-gray-700 bg-black/50 hover:bg-black/70 transition-colors p-10">
          <div className="pl-[270px] flex justify-center gap-16 -rotate-12 scale-110">
            {/* Left Column */}
