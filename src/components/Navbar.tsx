          ...
          >
            ...
            <div className="hidden md:flex space-x-6">
              {!isAuthenticated ? (
                ...
                <>
                  <Link href="/logo" className="nav-link">Logo</Link>
                  <Link href="/banner" className="nav-link">Banner</Link>
                  <Link href="/tagline" className="nav-link">Tagline</Link>
              ...
              <div className="flex flex-col space-y-4 py-4">
                {!isAuthenticated ? (
                  <>
                    ...
                    <MobileNavLink href="#showcase" onClick={() => setIsMobileMenuOpen(false)}>Showcase</MobileNavLink>
                  ...
                  <>
                    <Link href="/logo" className="mobile-nav-link" onClick={() => setIsMobileMenuOpen(false)}>Logo</Link>
                    <Link href="/banner" className="mobile-nav-link" onClick={() => setIsMobileMenuOpen(false)}>Banner</Link>
                    <Link href="/tagline" className="mobile-nav-link" onClick={() => setIsMobileMenuOpen(false)}>Tagline</Link>
                    <Link href="/profile" className="mobile-nav-link" onClick={() => setIsMobileMenuOpen(false)}>Profile</Link>
                    <button 
                      onClick={() => {
                        setIsMobileMenuOpen(false);
                        handleSignOut();
